...
public class ClientService {
    ...
    public void addClient(Client client) throws JSONException {

        clientRepo.save(client);
        clusterClient(client.getId());
    }


    public void updateClient(Client client) throws JSONException {
    ...
    public String clusterClient(String id) throws JSONException {
        ...
        try {
            ...
            //REZ IS MY RESULT!
            rez = myResponse.getString("results");
